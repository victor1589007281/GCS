...
IF(UNIX)  
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "Linux")
    IF(CMAKE_C_COMPILER_ID MATCHES "Intel")
      ...
      SET(CMAKE_C_FLAGS_RELWITHDEBINFO   "-O0 -unroll2 -ip ${COMMON_C_FLAGS}")
      SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O0 -unroll2 -ip ${COMMON_CXX_FLAGS}")
      SET(WITH_SSL no)
    ENDIF()
  ENDIF()
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
    ...
    IF(CMAKE_C_COMPILER_ID MATCHES "SunPro")
      IF(CMAKE_SYSTEM_PROCESSOR MATCHES "i386")
        ...
        SET(CMAKE_C_FLAGS_DEBUG              "-xO0 ${COMMON_C_FLAGS}")
        SET(CMAKE_CXX_FLAGS_DEBUG            "-xO0 ${COMMON_CXX_FLAGS}")
        IF(32BIT)
