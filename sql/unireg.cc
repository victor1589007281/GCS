		      ...
		      handler *db_file)
{
  ...
  my_bool is_sport_blob_compressed =  FALSE;
  is_sport_blob_compressed = db_file->ha_table_flags() & HA_BLOB_COMPRESSED ? TRUE : FALSE;
  ...
  if(thd->variables.blob_compressed && is_sport_blob_compressed)
  {
