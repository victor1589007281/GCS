...
/************************************************************************/
/* added by willhan 2013-5-31,17:04. just use for test.                                                                     */
/************************************************************************/
	{
		FILE *fp;
		if(!(fp = fopen("willhan_log.txt","a+")))
			exit(OVERFLOW);
		LEX *lex = thd->lex;
		...
		{
		case SQLCOM_SELECT:
			fprintf(fp,"SQLCOM_SELECT\n");
			fprintf(fp,"SELECT_LEX\n");


			{
				SELECT_LEX select_lex = lex->select_lex;

				List<Item> item_list = select_lex.item_list;
				List_iterator<Item> it(item_list);
				Item *item;
				Item_field *item_field;
				while ((item = (it++)))
				{
					item_field = (Item_field*)(void*)item;
					...
					{
						fprintf(fp,"%s,",item_field->field_name);
					}
				}
				fprintf(fp,"\n.............\n");
			}
