...
enum enum_warning_types {WARNINGS_DEFAULT, DROP_DB, DROP_TABLE, DROP_VIEW, DROP_COLUMN, ADD_OR_DROP_UNIQUE_KEY, TRUNCATE_TABLE, DELETE_WITHOUT_WHERE, UPDATE_WITHOUT_WHERE,
						...
						CREATE_TABLE_WITH_OTHER_CHARACTER, CREATE_PROCEDURE_WITH_DEFINER, USE_UNKNOWN_SYSTEM_VARIABLE,CREATE_TABLE_WITH_AUTOINCRE,
            ALTER_TABLE_CHANGE_COLUMN,ALTER_TABLE_ADD_INDEX, ALTER_TABLE_DROP_INDEX,
						OTHER_WARNINGS};
